...
const DiscoverSideBar = () => {
    return (
        <div className='h-[100vh] bg-[#ffff] w-[21.94vw] flex flex-col justify-between'>
            <button className='flex flex-col justify-center items-center w-[19.58vw] p-2 border-[2px] rounded-xl border-purple500 m-[20px] hover:bg-purple200'>
                ...
                <p className='text-[14px] mb-[30px] text-gray600 text-center'>Start find and Merry to get know and connect with new friend!</p>
            </button>
            <div>
