...
const DiscoverSideBar = () => {
    ...
    const renderedChat = mockChat.map(chat => {
        return (
            <div key={chat.name} className='flex py-[16px] px-[12px]'>
    ...
    return (
        <div className={location.pathname === "/match" ? 'pt-[90px] bg-white w-[316px] flex flex-col' : 'bg-white w-[316px] flex flex-col'}>
            ...
            <section>
                ...
                <div className="flex flex-wrap ml-[16px]">
                    {displayedUsers.map((user) => (
                        ...
                        >
                            <img src={merryHeart} alt="heart" className='z-40 absolute right-0 bottom-0 w-[20px] h-[20px]' />
                            <img src={merryHeart} alt="heart" className='z-30 absolute right-[10px] bottom-0 w-[20px] h-[20px]' />
                        </div>
                    ))}
                </div>
