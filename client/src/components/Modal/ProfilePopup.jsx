...
function ProfilePopup(props) {
  ...
  const pictureToRender = [...user.image];
  const numberPicturesProfile = pictureToRender.length;
            ...
            <div className="w-1/2 pl-[60px] pt-6 flex flex-col space-y-10">
              ...
              <div className="flex flex-col justify-center">
                ...
                <div className="flex flex-row items-center py-2">
                  ...
                  <p className="text-gray-700 text-xl font-semibold">
                    {capitalize(user.sexual_preferences) || ""}
                  </p>
                </div>
                <div className="flex flex-row items-center py-2">
                  <p className="w-[191px] text-gray-900 text-base font-normal">
                  ...
                  <p className="text-gray-700 text-xl font-semibold">
                    {capitalize(user.racial_preferences) || ""}
                  </p>
                </div>
                <div className="flex flex-row items-center py-2">
                  <p className="w-[191px] text-gray-900 text-base font-normal">
                  ...
                  <p className="text-gray-700 text-xl font-semibold">
                    {capitalize(user.meeting_interests) || ""}
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col space-y-6">
                ...
                <div className="w-full flex flex-wrap flex-row gap-3">
                  {user.hobby_interests.map((tag, index) => {
                    return (
                      <div
                        key={index}
