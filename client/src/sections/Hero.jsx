...
function Hero() {
    return (
        <>
            <section className="bg w-full flex justify-center relative font-nunito">            
                ...
                <p className="text-white text-[12px] bg-red700 w-[153px] h-[41px] rounded-tl-full rounded-tr-full rounded-bl-full absolute top-[336px] left-[160px] flex justify-center items-center">Nice to meet you too!</p>            
            </section>
        </>
    )
}
