...
function MerryListPage() {
    ...
    const renderedMatch = matchLists.map((user) => {
        return (
            <div key={user.user_id} className="flex justify-evenly border-solid border-b-[1px] border-gray-300 mb-[24px] pb-[40px] pt-[16px]">
                <section className="flex w-[674px]">
                    <img 
                        src={user.image[0].url} alt="user's profile pic" 
                    ...
                    <div>
                        <section className="flex justify-start pb-[24px]">
                            <div className="flex mr-[16px]">
                                ...
                                <p className="text-gray-700 text-[24px] font-bold">{user.age || "N/A"}</p>
                            </div>
                        ...
                        <section className="text-[16px] flex">
                            ...
                            <div className="text-gray-600">
                                <p className="pb-[10px]">{user.sex_identities || "N/A"}</p>
                                <p className="pb-[10px]">{user.sexual_preferences || "N/A"}</p>
                                <p className="pb-[10px]">{user.racial_preferences || "N/A"}</p>
                                <p className="pb-[10px]">{user.meeting_interests || "N/A"}</p>
                            </div>                        
                        </section>
                    </div>
                </section>
                <section className="flex flex-col items-end">
                    ...
                    <div className="flex justify-end w-[176px]">
                        ...
                        <div className="w-[48px] h-[48px] bg-red-500 flex justify-center items-center rounded-2xl ml-[16px] hover:cursor-pointer" onClick={onOpen}>
                            <img src={merrySelected} alt="merry icon" />
                            <UnmatchConfirmationDialog isOpen={isOpen} onClose={onClose} onConfirm={handleUnmatchConfirm} />
                        </div>
                    </div>
                </section>               
            </div>
